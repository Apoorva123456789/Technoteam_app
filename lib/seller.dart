                   ...
                   child: HoverCard(
                     builder: (context, hovering) {
                       return Container(
                         ...
                         child: Center(
                           child: Image.asset('asset/person.jpg'),
                         ),
                       );
                     },
                     depth: 10,
                     ...
                     shadow: BoxShadow(color: Colors.deepOrangeAccent, blurRadius: 30, spreadRadius: -20, offset: Offset(0, 40)),
                   ),
...
SizedBox(
  height:50,
             ...
             Container(child:Text('Create A gig',style:TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.deepOrangeAccent),)),
             ...
             Container(child:Text('Deliver great work',style:TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.deepOrangeAccent),)),
             ...
             Container(child:Text('Get paid',style:TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.deepOrangeAccent),)),
  ...
  height:50,
          ...
          Container(
            child: Column(
               ...
               // mainAxisAlignment: MainAxisAlignment.center,
                children:[
                  CircleAvatar(child: Image.asset('asset/fire.png', height: 90,),backgroundColor: Colors.deepOrangeAccent,),
                  Center(
            ...
            text: 'Sign up and create your first Gig ',
              ...
              children: <TextSpan>[
                    TextSpan(text: 'Today', style: TextStyle(fontWeight: FontWeight.bold, color:Colors.deepOrangeAccent)),
                    TextSpan(text: ' !'),
              ],
            ),
          ),
                  ...
                  Padding(
                    padding: const EdgeInsets.all(20.0),
                    child: Text('Become a top seller on our platform and start making profits online',style:TextStyle(fontSize: 20, color:Colors.deepOrangeAccent  ),),
                  ),
                  ElevatedButton.icon(
                    ...
                    label:Padding(
                      ...
                      child: Text('Lets get started', style:TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),
                    ),
                  ),
SizedBox(height: 40),
